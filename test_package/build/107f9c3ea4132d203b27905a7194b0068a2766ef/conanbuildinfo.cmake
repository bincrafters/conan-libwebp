...
set(CONAN_LIBWEBP_ROOT "C:/Users/jerry/.conan/data/libwebp/0.6.0/bincrafters/testing/package/6cc50b139b9c3d27b3e9042d5f5372d327b3a9f7")
set(CONAN_INCLUDE_DIRS_LIBWEBP "C:/Users/jerry/.conan/data/libwebp/0.6.0/bincrafters/testing/package/6cc50b139b9c3d27b3e9042d5f5372d327b3a9f7/include")
set(CONAN_LIB_DIRS_LIBWEBP "C:/Users/jerry/.conan/data/libwebp/0.6.0/bincrafters/testing/package/6cc50b139b9c3d27b3e9042d5f5372d327b3a9f7/lib")
set(CONAN_BIN_DIRS_LIBWEBP )
set(CONAN_RES_DIRS_LIBWEBP )
set(CONAN_BUILD_DIRS_LIBWEBP "C:/Users/jerry/.conan/data/libwebp/0.6.0/bincrafters/testing/package/6cc50b139b9c3d27b3e9042d5f5372d327b3a9f7/")
set(CONAN_LIBS_LIBWEBP webp)
...
set(CONAN_DEPENDENCIES libwebp)
...
set(CONAN_INCLUDE_DIRS "C:/Users/jerry/.conan/data/libwebp/0.6.0/bincrafters/testing/package/6cc50b139b9c3d27b3e9042d5f5372d327b3a9f7/include" ${CONAN_INCLUDE_DIRS})
set(CONAN_LIB_DIRS "C:/Users/jerry/.conan/data/libwebp/0.6.0/bincrafters/testing/package/6cc50b139b9c3d27b3e9042d5f5372d327b3a9f7/lib" ${CONAN_LIB_DIRS})
set(CONAN_BIN_DIRS  ${CONAN_BIN_DIRS})
set(CONAN_RES_DIRS  ${CONAN_RES_DIRS})
set(CONAN_LIBS webp ${CONAN_LIBS})
set(CONAN_DEFINES  ${CONAN_DEFINES})
set(CONAN_CMAKE_MODULE_PATH "C:/Users/jerry/.conan/data/libwebp/0.6.0/bincrafters/testing/package/6cc50b139b9c3d27b3e9042d5f5372d327b3a9f7/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    conan_find_libraries_abs_path("${CONAN_LIBS_LIBWEBP}" "${CONAN_LIB_DIRS_LIBWEBP}"
                                  CONAN_FULLPATH_LIBS_LIBWEBP)
    conan_find_libraries_abs_path("${CONAN_LIBS_LIBWEBP_DEBUG}" "${CONAN_LIB_DIRS_LIBWEBP_DEBUG}"
                                  CONAN_FULLPATH_LIBS_LIBWEBP_DEBUG)
    conan_find_libraries_abs_path("${CONAN_LIBS_LIBWEBP_RELEASE}" "${CONAN_LIB_DIRS_LIBWEBP_RELEASE}"
                                  CONAN_FULLPATH_LIBS_LIBWEBP_RELEASE)

    add_library(CONAN_PKG::libwebp INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::libwebp PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_FULLPATH_LIBS_LIBWEBP} ${CONAN_SHARED_LINKER_FLAGS_LIBWEBP_LIST} ${CONAN_EXE_LINKER_FLAGS_LIBWEBP_LIST}
                                                                 $<$<CONFIG:Release>:${CONAN_FULLPATH_LIBS_LIBWEBP_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_LIBWEBP_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_LIBWEBP_RELEASE_LIST}>
                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_FULLPATH_LIBS_LIBWEBP_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_LIBWEBP_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_LIBWEBP_RELEASE_LIST}>
                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_FULLPATH_LIBS_LIBWEBP_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_LIBWEBP_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_LIBWEBP_RELEASE_LIST}>
                                                                 $<$<CONFIG:Debug>:${CONAN_FULLPATH_LIBS_LIBWEBP_DEBUG} ${CONAN_SHARED_LINKER_FLAGS_LIBWEBP_DEBUG_LIST} ${CONAN_EXE_LINKER_FLAGS_LIBWEBP_DEBUG_LIST}>
                                                                 )
    ...
    set(CONAN_TARGETS CONAN_PKG::libwebp)
